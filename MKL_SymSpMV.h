...
#pragma omp parallel for
    ...
    mkl_sparse_d_create_csr(&A, SPARSE_INDEX_BASE_ZERO, m, m, row_start, row_end, csrColIdxA, csrValA);
    descr.type = SPARSE_MATRIX_TYPE_SYMMETRIC;
    descr.mode = SPARSE_FILL_MODE_UPPER;
    descr.diag = SPARSE_DIAG_NON_UNIT;
    
    mkl_sparse_set_mv_hint(A, SPARSE_OPERATION_NON_TRANSPOSE, descr, BENCH_REPEAT);
